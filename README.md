# Functional Python [![](https://github.com/somu-a/functional-python/workflows/tests/badge.svg)](https://github.com/somu-a/functional-python/actions?query=workflow%3Atests)
